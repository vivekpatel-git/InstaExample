...
public class InstagramSession {
    ...
    private static final String FOLLOWSBY = "followsby";
    ...
    public void store(InstagramUser user) {
        ...
        editor.putString(MEDIA, user.media);
        editor.putString(FOLLOWS, user.follows);
        editor.putString(FOLLOWSBY, user.followed_by);
    ...
    public InstagramUser getUser() {
        ...
        user.media = mSharedPref.getString(MEDIA, "");
        user.follows = mSharedPref.getString(FOLLOWS, "");
        user.followed_by = mSharedPref.getString(FOLLOWSBY, "");
